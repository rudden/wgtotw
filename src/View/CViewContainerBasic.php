...
class CViewContainerBasic implements \Anax\DI\IInjectionAware
{
     ...
     * @return $this
     */
    public function add($template, $data = [], $region = 'posts', $sort = 0)
    {
     ...
     * @return $this
     */
    public function addCallback($callback, $data = [], $region = 'posts', $sort = 0)
    {
        $view = $this->di->get('view');
     ...
     * @return $this
     */
    public function addString($content, $region = 'posts', $sort = 0)
    {
        $view = $this->di->get('view');
     ...
     * @return $this
     */
    public function render($region = 'posts')
    {
